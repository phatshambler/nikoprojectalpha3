...
;  var ContextResolver, Hydrate, MultiResolver, Resolver;
  ...
  Hydrate = (function() {
    ...
    Util = (function() {
      ...
      Util.supportsProto = {}.__proto__ != null;
      Util.supportsFunctionNames = typeof (function() {}).name === "string";
      Util.functionName = function(func) {
        var _ref;
    ...
    Hydrate.Util = Util;
    Hydrate.NonPrototypeFunctionError = (function() {
      __extends(NonPrototypeFunctionError, Error);
    ...
    Hydrate.PrototypeNotFoundError = (function() {
      __extends(PrototypeNotFoundError, Error);
    ...
    Hydrate.AnonymousConstructorError = (function() {
      __extends(AnonymousConstructorError, Error);
    ...
    Hydrate.VersionInstancePropertyError = (function() {
      __extends(VersionInstancePropertyError, Error);
    ...
    function Hydrate(resolver) {
      ...
      if (!(this.resolver != null)) {
        this.resolver = new ContextResolver(window);
      }
    ...
    Hydrate.prototype.fixTree = function(obj) {
      var k, k2, m, proto, t, tmp, v, v2, _len;
      if (obj instanceof Array) {
        for (k = 0, _len = obj.length; k < _len; k++) {
          v = obj[k];
          v = this.fixTree(v);
    ...
    Hydrate.prototype.clean = function(o, cleaned) {
      var k, migrations, num, v, _ref, _ref2;
      if (cleaned == null) {
        cleaned = [];
      }
      migrations = this.migrations[o.__hydrate_cons];
      if ((o.version != null) && (migrations != null) && o.version < migrations.length) {
        for (num = _ref = o.version, _ref2 = migrations.length - 1; (_ref <= _ref2 ? num <= _ref2 : num >= _ref2); (_ref <= _ref2 ? num += 1 : num -= 1)) {
  ...
  ContextResolver = (function() {
    __extends(ContextResolver, Resolver);
  ...
  MultiResolver = (function() {
    __extends(MultiResolver, Resolver);
